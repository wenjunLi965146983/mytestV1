...
def _main():
    ...
    if is_tiny_version:
        model = create_tiny_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='lwjyolo/model_data/tiny_yolo_weights.h5')
    else:
        model = create_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='lwjyolo/model_data/yolo_weights.h5') # make sure you know what you freeze
...
def create_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
            weights_path='lwjyolo/logs/000/ep048-loss318.872-val_loss240.009.h5'):
